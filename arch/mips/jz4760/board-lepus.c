...
struct mmc_partition_info lepus_partitions[] = {
	...
	[4] = {"rootfs",8*1024*1024,250*1024*1024,1}, //250MB
	[5] = {"data",258*1024*1024,90*1024*1024,1},  //90MB app
	[6] = {"cache",348*1024*1024,30*1024*1024,1}, //30MB cfg
	[7] = {"test_0",378*1024*1024,3359*1024*1024UL,0},//4G is 3737
...
#ifdef CONFIG_DLV_CS4398
	{
		I2C_BOARD_INFO("DAC4398",(CS4398_ADDR>>1)),
	},
#endif

#ifdef CONFIG_DLV_ESS9016
	{
		I2C_BOARD_INFO("ESS9016",(ESS9016_ADDR>>1)),
	},
#endif
...
#ifdef CONFIG_PMU_AXP202_SUPPORT
	{
...
static struct gpio_keys_button board_buttons[] = {
	{
		.gpio           = GPIO_POWER_ON,//COLORFLY_KEY_SLEEP,
		.code           = KEY_1,
		.desc           = "KEY_1",
		.active_low     = ACTIVE_LOW,//ACTIVE_LOW_WAKE_UP
	},
};
