...
struct mmc_partition_info lepus_partitions[] = {
	...
	[4] = {"rootfs",8*1024*1024,100*1024*1024,1}, //250MB

	[5] = {"data",108*1024*1024,100*1024*1024,1},  //90MB app
	[6] = {"cache",208*1024*1024,30*1024*1024,1}, //30MB cfg
	[7] = {"test_0",238*1024*1024,14602*1024*1024UL,0},//4G is 3737 16G=14840
