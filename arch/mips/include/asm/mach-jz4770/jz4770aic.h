/*
 * chip-aic.h
 * JZ4770 AIC register definition
 * Copyright (C) 2011 Ingenic Semiconductor Co., Ltd.
 *
...
#define AIC_I2SDIV_IDIV_LSB	8
#define AIC_I2SDIV_IDIV_MASK	BITS_H2L(11, AIC_I2SDIV_IDIV_LSB)
