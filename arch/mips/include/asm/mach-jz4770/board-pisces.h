...
#define GPIO_GWTC9XXXB_INT              (32 * 4 + 0)    //GPE0
#define GPIO_GWTC9XXXB_RST              (32 * 4 + 5)    //GPE05
#define GPIO_GWTC9XXXB_IRQ              (IRQ_GPIO_0 + GPIO_GWTC9XXXB_INT )/* Used for GPIO-based bitbangi
ng I2C*/ 
