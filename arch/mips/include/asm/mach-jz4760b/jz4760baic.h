...
#define __spdif_get_reset()               ((REG_SPDIF_CTRL & SPDIF_CTRL_RST) >> 11)
#define __spdif_clear_tur()               ( REG_SPDIF_STATE &= ~SPDIF_STAT_FUR )
...
#define __spdif_enable_samwl_20()    ( REG_SPDIF_CFG2 &= ~SPDIF_CFG2_MAXWL )
